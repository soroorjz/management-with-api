...
const ExamIntroduction = () => {
  const exams = [
    { id: 1, name: "یازدهمین آزمون مشترک دستگاه های اجرایی" },
    { id: 2, name: "اولین آزمون استخدامی اختصاصی معلولان" },
    { id: 3, name: "آزمون استخدامی وزارت بهداشت، درمان و آموزش پزشکی" },
    { id: 4, name: "دوازدهمین امتحان مشترک فراگیر دستگاه‌های اجرایی" },
    { id: 5, name: "یازدهمین آزمون مشترک وزارت نفت" },
  ];
  ...
  const handleConfirm = () => {
    ...
    const newExam = {
      ...
      name: exams.find((exam) => exam.id === parseInt(selectedExam)).name,
