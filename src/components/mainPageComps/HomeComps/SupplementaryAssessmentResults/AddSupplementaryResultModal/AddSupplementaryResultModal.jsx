...
const AddSupplementaryResultModal = ({
  ...
  const handleChange = (key, value) => {
    setNewResult((prev) => ({ ...prev, [key]: value }));
  };
  ...
  const assessmentNameOptions = [
    ...
    { value: "آزمون استخدامی", label: "آزمون استخدامی" },
    { value: "آزمون ارتقاء", label: "آزمون ارتقاء" },
    { value: "آزمون تخصصی", label: "آزمون تخصصی" },
  ];
              ...
              <div className="add-supplementary-result-modal__form-group">
                ...
                {isEditMode ? (
                  ...
                  <select
                    ...
                    required
                  >
                    {assessmentNameOptions.map((option) => (
