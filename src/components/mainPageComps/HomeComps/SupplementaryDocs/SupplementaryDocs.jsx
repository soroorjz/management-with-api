...
const SupplementaryDocs = () => {
  ...
  const handleAddDoc = (newDocData) => {
    ...
    const docToAdd = {
      ...
      examDate: newDocData.examDate
        ? newDocData.examDate.format("YYYY/MM/DD")
        : "",
      ...
      docs.map((doc) =>
        doc.id === selectedDoc.id
          ? {
              ...
              examDate: updatedDocData.examDate
                ? updatedDocData.examDate.format("YYYY/MM/DD")
                : "",
